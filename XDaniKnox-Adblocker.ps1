...
"@
    ...
    Write-Host "    [$("█" * 50)] 100%" -ForegroundColor Green
    Write-Host ""
    Start-Sleep -Milliseconds 200
    
    # Animált "MADE BY XDaniKnox" effekt
    $text = "    ╔════════════════════════════════════════════════════════════╗"
    ...
    for ($i = 0; $i -lt 5; $i++) {
        ...
        Write-Host $logo -ForegroundColor Cyan
        Write-Host ""
        Write-Host $text -ForegroundColor $colors[$i % $colors.Length]
        Write-Host $text2 -ForegroundColor $colors[($i+1) % $colors.Length]
        Write-Host $text3 -ForegroundColor $colors[($i+2) % $colors.Length]
        Write-Host ""
    ...
    Write-Host $text3 -ForegroundColor White
    Write-Host ""
    Write-Host "    ✦ Sikeresen betöltve! ✦" -ForegroundColor Green
...
# Menü megjelenítése és választás kezelése
$choice = $null
do {
    Show-Menu
...
# ============================================
# XDaniKnox ADBLOCKER - KONFIGURÁCIÓ
# ============================================

Write-Host ""
Write-Host "    ╔════════════════════════════════════════════════════════════╗" -ForegroundColor Cyan
Write-Host "    ║  🔧 XDaniKnox Adblocker - Konfiguráció betöltése...     ║" -ForegroundColor Cyan
Write-Host "    ╚════════════════════════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
...
# ============================================
# XDaniKnox ADBLOCKER - DEFENDER KIZÁRÁS
# ============================================

Write-Host "    ╔════════════════════════════════════════════════════════════╗" -ForegroundColor Cyan
Write-Host "    ║  🛡️ Windows Defender kizárások ellenőrzése...             ║" -ForegroundColor Cyan
Write-Host "    ╚════════════════════════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
...
# ============================================
# XDaniKnox ADBLOCKER - SPOTIFY LEÁLLÍTÁS
# ============================================

Write-Host "    ╔════════════════════════════════════════════════════════════╗" -ForegroundColor Cyan
Write-Host "    ║  ⏹️ Spotify folyamatok leállítása...                      ║" -ForegroundColor Cyan
Write-Host "    ╚════════════════════════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
...
# ============================================
# XDaniKnox ADBLOCKER - FŐ FOLYAMAT
# ============================================

Write-Host "    ╔════════════════════════════════════════════════════════════╗" -ForegroundColor Cyan
Write-Host "    ║  🔧 Spotify módosítása folyamatban...                     ║" -ForegroundColor Cyan
Write-Host "    ╚════════════════════════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
...
$regex5 = $old -notmatch $(if ([version]$offline -gt [version]'1.2.73.474') { $webjson.others.binary.block_gabo2.add } else { $webjson.others.binary.block_gabo.add })
